...
List deduplicated_words_map(String doc_string);                      // Read a string and create a list with each word (no duplicate words are inserted)

List deduplicated_words_map_small(String doc_str);                   // Read a string and create a list with each word (no duplicate words are inserted)
