![example branch parameter](https://github.com/vasiliki2000/project-SIGMOD-2013/actions/workflows/c.yml/badge.svg?branch=part1)
# project-SIGMOD-2013
...
- To compile the program so index is created with EXACT_MATCH go to commmon.mk at line 50 and set the last option to "-DEXACT"
- To compile the program so index is created with Hamming_Distance go to commmon.mk at line 50 and set the last option to "-DHAMMING"
- To compile the program so index is created with Edit_Distance go to commmon.mk at line 50 and set the last option to "-DEDIT"
